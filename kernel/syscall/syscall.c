...
intptr syscall_dispatch(uintptr num, uintptr arg1, uintptr arg2, uintptr arg3,
    ...
    switch (num) {
        ...
        case SYS_PING6: return sys_ping6((const uint8 *)arg1, (uint32)arg2);
        case SYS_DNS_RESOLVE_AAAA: return sys_dns_resolve_aaaa((const char *)arg1, (uint8 *)arg2);
        ...
        case SYS_TCP_CONNECT_IPV6: return sys_tcp_connect_ipv6((const uint8 *)arg1, (uint16)arg2);
        case SYS_TCP_LISTEN_IPV6: return sys_tcp_listen_ipv6((uint16)arg1);
